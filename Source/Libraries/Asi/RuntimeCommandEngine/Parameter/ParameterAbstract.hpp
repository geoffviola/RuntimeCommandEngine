#ifndef _ASI_RUNTIMECOMMANDENGINE_PARAMETERASTRACT_HPP_
#define _ASI_RUNTIMECOMMANDENGINE_PARAMETERASTRACT_HPP_
...
#endif //_ASI_RUNTIMECOMMANDENGINE_PARAMETERASTRACT_HPP_
